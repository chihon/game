...
/*SF_DATA;ver:1.18;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,rpth:0,hqsc:False,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:4013,x:32719,y:32712,varname:node_4013,prsc:2|diff-7500-OUT,emission-5575-OUT;n:type:ShaderForge.SFN_Color,id:1304,x:31572,y:32037,ptovrint:False,ptlb:Color Tint,ptin:_ColorTint,varname:node_1304,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Floor,id:2499,x:31635,y:33009,varname:node_2499,prsc:2|IN-653-OUT;n:type:ShaderForge.SFN_TexCoord,id:8412,x:30920,y:32651,varname:node_8412,prsc:2,uv:0;n:type:ShaderForge.SFN_Lerp,id:4003,x:31934,y:32505,varname:node_4003,prsc:2|A-1092-RGB,B-8794-RGB,T-421-OUT;n:type:ShaderForge.SFN_Blend,id:7500,x:32398,y:32374,varname:node_7500,prsc:2,blmd:3,clmp:True|SRC-1304-RGB,DST-4003-OUT;n:type:ShaderForge.SFN_Color,id:1092,x:31559,y:32398,ptovrint:False,ptlb:Pixel Color1,ptin:_PixelColor1,varname:_ColorDiffuse_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5735294,c2:0.5735294,c3:0.5735294,c4:1;n:type:ShaderForge.SFN_Color,id:8794,x:31559,y:32567,ptovrint:False,ptlb:Pixel Color2,ptin:_PixelColor2,varname:_PixelColor2,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Slider,id:4452,x:30708,y:32913,ptovrint:False,ptlb:U Pixel size ,ptin:_UPixelsize,varname:node_4452,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:256;n:type:ShaderForge.SFN_Noise,id:421,x:31829,y:32856,varname:node_421,prsc:2|XY-2499-OUT;n:type:ShaderForge.SFN_Multiply,id:653,x:31334,y:32791,varname:node_653,prsc:2|A-8412-UVOUT,B-1622-OUT;n:type:ShaderForge.SFN_Append,id:1622,x:31130,y:32900,varname:node_1622,prsc:2|A-4452-OUT,B-7075-OUT;n:type:ShaderForge.SFN_Slider,id:7075,x:30708,y:33016,ptovrint:False,ptlb:V Pixel size ,ptin:_VPixelsize,varname:_UPixelsize_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:256;n:type:ShaderForge.SFN_Slider,id:2736,x:32112,y:33039,ptovrint:False,ptlb:Emissive,ptin:_Emissive,varname:node_3936,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:2;n:type:ShaderForge.SFN_Multiply,id:5575,x:32528,y:32923,varname:node_5575,prsc:2|A-7500-OUT,B-2736-OUT;proporder:1304-2736-1092-8794-4452-7075;pass:END;sub:END;*/

Shader "Ciconia Studio/Effects/Blend/Pixel/Color" {
    Properties {
        _ColorTint ("Color Tint", Color) = (1,1,1,1)
        _Emissive ("Emissive", Range(0, 2)) = 0
        _PixelColor1 ("Pixel Color1", Color) = (0.5735294,0.5735294,0.5735294,1)
...
/////// Diffuse:
                ...
                float3 node_7500 = saturate((_ColorTint.rgb+lerp(_PixelColor1.rgb,_PixelColor2.rgb,node_421)-1.0));
